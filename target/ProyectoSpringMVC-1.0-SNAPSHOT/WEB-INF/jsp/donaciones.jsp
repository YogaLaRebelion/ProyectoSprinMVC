<%-- 
    Document   : donaciones
    Created on : Jun 9, 2023, 7:06:54 PM
    Author     : Melody
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Gracias por tu Interes en Apoyarnos!!</h1>
        <h3>Te dejamos los datos para que puedas hacer una transferencia</h3>

        <p>Banco estado</p>
        <p>  Chequera electronica</p>
        <p>  Cuenta: 25171030253</p>
        <p>    Rut: 65.217.136-2</p>
        <p>       fundacionkriya@gmail.com</p>
